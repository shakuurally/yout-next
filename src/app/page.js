      ...
      <div className="flex continer p-8 mx-auto flex-wrap ">
        <div className='flex items-center w-full lg:w-1/2'>
          <div className='max-w2xl mb-8'>
            ...
            '>Hello buy or sell something </h1>{" "}
            <p className='py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl '>
              online shopping, digital downloads, online subscriptions, and
              online ticketing. It has revolutionized the way people do business
              and has become an increasingly popular way to shop due to its
              convenience and accessibility..
            </p>
            {/* button */}
            <div >
              <Link href="products" className='px-8 w-52 text-white bg-indigo-600  rounded-md py-4'>products</Link>
            </div>
          </div>
        </div>
        {/* image */}
