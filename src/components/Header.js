    ...
    <body>
      <nav className="relative px-4 py-4 container shadow mx-auto flex items-center justify-between bg-white">
        ...
        <ul className="flex items-center space-x-5">
            <li className="text-sm text-black  hover:text-gray-500"><Link href="/">Home</Link></li>
            <li className="text-sm text-black hover:text-gray-500"><Link href="/products">Products</Link></li>
        ...
        {/* right */}
        {
          userloged ? (
            <div className="flex cursor-pointer items-center ">
              <h1 className="text-gray-500 truncate w-24">{userloged.displayName}</h1>
              <img src={farmattedPhot} alt="" className="inline-block w-8 h-8 rounded-full ring-2 ring-white" />
            </div>
          ):(
             <div>
          <button className="flex items-center space-x-2 px-6 py-2 bg-blue-500 hover:bg-blue-600 text-sm
